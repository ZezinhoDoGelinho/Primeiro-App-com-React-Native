...
//Essa massaroca é so pra deixar o estilo dinamico
...
export const Title = styled.Text`
    ...
    font-size:       ${props => (fonts.title.size[props.variant || 'normal'])};
    line-height:     ${props => (fonts.title.size[props.variant || 'normal'])};
...
export const Text = styled.Text.attrs(props => ({
    ...
    font-size: ${props => fonts.text.size[props.variant || 'normal']};
...
export const Tochable = styled.TouchableOpacity`
    display: flex;
    overflow: hidden;
    flex: ${props => (props.height ? 'none' : 1)};
    width: ${props => (props.fluid ? '100%' : props.width || 'auto')};
...
export const ScrollViewL = styled.ScrollView.attrs({
